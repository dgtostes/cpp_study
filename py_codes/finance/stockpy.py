...
class Quotes(object):
    ...
    def __init__(self, instrument):
        ...
        self.dic_info = self.__get_quote_from_instrument_list()
    ...
    def __expose_dic(self):
        ...
        return "intrument: %s open: %s max: %s min: %s"\
              ...
              " slope_vol: %s deg_vol: %s" %  (self.dic_info[0]['instrument'],
                                                     self.dic_info[0]['open'],
                                                     self.dic_info[0]['max'],
                                                     self.dic_info[0]['min'],
                                                     self.dic_info[0]['last_price'],
                                                     self.dic_info[0]['osc'],
                                                     slope_quote,
                                                     a_tan_deg_quote,
                                                     slope_vol,
    ...
    def __history_dic(self):
        ...
        url_target = "http://ichart.finance.yahoo.com/"\
                     ...
                     "=%s&e=%s&f=%s&g=d&ignore=.csv" % (self.dic_info[0]['instrument'],
                                                        start_month,
                                                        start_day,
                                                        start_year,
                                                        today_month,
        ...
        try:
            ...
            history_dic = {}
            history_dic[self.dic_info[0]['instrument']] = {}
            for i in html_list:
                data_list = i.split(',')
                date = process_date_string(data_list[0])
                history_dic[self.dic_info[0]['instrument']][date] = {}        
    ...
    def __history_analysis(self):
        ...
        of the quote curve
        '''
        instrument = self.dic_info[0]['instrument']
        dic = {}
        if self.history_dic:
